...
namespace Learn.CSharp.Language.DataTypes.Tests
{
    ...
    public class StringTests
    {
        ...
        public void String_With_Same_Content_Equal_Test()
        {
            ...
            Assert.IsTrue(string.Equals(first, second, StringComparison.InvariantCultureIgnoreCase));
        }
        ...
        public void String_Different_Case_Are_Not_Equal_Test()
        {
            ...
            Assert.AreNotSame(first, second); //check if strings refers to same object in memory
        }
